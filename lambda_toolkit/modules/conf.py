...
class Conf:
    ...
    def read_config(self):
        ...
        if not os.path.isfile(self.config_file):
            ...
            self.config.set("settings", "C_LAMBDAPROXY_FUNC", "\"lambda_toolkit/templates/lambda-proxy/index.py\"")
            self.config.set("settings", "C_LAMBDASTANDARD_FUNC", "\"lambda_toolkit/templates/standard-lambda/index.py\"")
